 ...
 * JMMC project
 * 
 * "@(#) $Id: errUserGetInLocalStack_L.c,v 1.1 2005-01-27 14:12:55 gzins Exp $"
 *
 * History
 * -------
...
static char *rcsId="@(#) $Id: errUserGetInLocalStack_L.c,v 1.1 2005-01-27 14:12:55 gzins Exp $"; 
...
{
    logExtDbg("errGetUserMsgInLocalStack()");
