...
* JMMC project
*
* "@(#) $Id: gwtCHECKBOX.C,v 1.1 2004-12-01 15:34:46 mella Exp $"
*
* who       when         what
* --------  -----------  -------------------------------------------------------
...
/**
 * \file
 * gwtCHECKBOX class definition file.
 */

static char *rcsId="@(#) $Id: gwtCHECKBOX.C,v 1.1 2004-12-01 15:34:46 mella Exp $"; 
