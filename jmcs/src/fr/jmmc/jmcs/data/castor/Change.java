 ...
 * Schema.
 * $Id: Change.java,v 1.2 2011-02-15 17:01:57 mella Exp $
 */
...
public class Change implements java.io.Serializable {
     ...
     * @param reader
     */
    public static fr.jmmc.jmcs.data.castor.Change unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.jmmc.jmcs.data.castor.Change) Unmarshaller.unmarshal(fr.jmmc.jmcs.data.castor.Change.class, reader);
    } //-- fr.jmmc.mcs.gui.castor.Change unmarshal(java.io.Reader) 
