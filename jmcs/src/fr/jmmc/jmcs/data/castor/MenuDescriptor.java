 ...
 * Schema.
 * $Id: MenuDescriptor.java,v 1.2 2011-02-15 17:01:57 mella Exp $
 */
...
public class MenuDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MenuDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _checkbox
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_checkbox", "checkbox", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Menu target = (Menu) object;
                    target.setCheckbox( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
        //-- _radiogroup
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_radiogroup", "radiogroup", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Menu target = (Menu) object;
                    target.setRadiogroup( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _radiogroup
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            StringValidator typeValidator = new StringValidator();
            typeValidator.setWhiteSpace("preserve");
        ...
        //-- _menuList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(fr.jmmc.jmcs.data.castor.Menu.class, "_menuList", "menu", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Menu target = (Menu) object;
                    target.addMenu( (fr.jmmc.jmcs.data.castor.Menu) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new fr.jmmc.jmcs.data.castor.Menu();
            }
        } );
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- fr.jmmc.mcs.gui.castor.MenuDescriptor()
    ...
    {
        return fr.jmmc.jmcs.data.castor.Menu.class;
