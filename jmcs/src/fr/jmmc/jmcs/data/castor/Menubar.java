 ...
 * Schema.
 * $Id: Menubar.java,v 1.2 2011-02-15 17:01:57 mella Exp $
 */
...
public class Menubar implements java.io.Serializable {
     ...
     * @param vMenu
     */
    public void addMenu(fr.jmmc.jmcs.data.castor.Menu vMenu)
     ...
     * @param vMenu
     */
    public void addMenu(int index, fr.jmmc.jmcs.data.castor.Menu vMenu)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param index
     */
    public fr.jmmc.jmcs.data.castor.Menu getMenu(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (fr.jmmc.jmcs.data.castor.Menu) _menuList.get(index);
    } //-- fr.jmmc.mcs.gui.castor.Menu getMenu(int) 

    /**
     * Method getMenu
     */
    public fr.jmmc.jmcs.data.castor.Menu[] getMenu()
    {
        int size = _menuList.size();
        fr.jmmc.jmcs.data.castor.Menu[] mArray = new fr.jmmc.jmcs.data.castor.Menu[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (fr.jmmc.jmcs.data.castor.Menu) _menuList.get(index);
        }
        return mArray;
     ...
     * @param vMenu
     */
    public boolean removeMenu(fr.jmmc.jmcs.data.castor.Menu vMenu)
    {
     ...
     * @param vMenu
     */
    public void setMenu(int index, fr.jmmc.jmcs.data.castor.Menu vMenu)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _menuList.size())) {
     ...
     * @param menuArray
     */
    public void setMenu(fr.jmmc.jmcs.data.castor.Menu[] menuArray)
    {
        //-- copy array
        _menuList.clear();
     ...
     * @param reader
     */
    public static fr.jmmc.jmcs.data.castor.Menubar unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.jmmc.jmcs.data.castor.Menubar) Unmarshaller.unmarshal(fr.jmmc.jmcs.data.castor.Menubar.class, reader);
