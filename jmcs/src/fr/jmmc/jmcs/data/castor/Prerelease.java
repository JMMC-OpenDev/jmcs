...
public class Prerelease implements java.io.Serializable {
     ...
     * @param vChange
     */
    public void addChange(fr.jmmc.jmcs.data.castor.Change vChange)
     ...
     * @param vChange
     */
    public void addChange(int index, fr.jmmc.jmcs.data.castor.Change vChange)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param index
     */
    public fr.jmmc.jmcs.data.castor.Change getChange(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (fr.jmmc.jmcs.data.castor.Change) _changeList.get(index);
    } //-- fr.jmmc.mcs.gui.castor.Change getChange(int) 

    /**
     * Method getChange
     */
    public fr.jmmc.jmcs.data.castor.Change[] getChange()
    {
        int size = _changeList.size();
        fr.jmmc.jmcs.data.castor.Change[] mArray = new fr.jmmc.jmcs.data.castor.Change[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (fr.jmmc.jmcs.data.castor.Change) _changeList.get(index);
        }
        return mArray;
     ...
     * @param vChange
     */
    public boolean removeChange(fr.jmmc.jmcs.data.castor.Change vChange)
    {
     ...
     * @param vChange
     */
    public void setChange(int index, fr.jmmc.jmcs.data.castor.Change vChange)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _changeList.size())) {
     ...
     * @param changeArray
     */
    public void setChange(fr.jmmc.jmcs.data.castor.Change[] changeArray)
    {
        //-- copy array
        _changeList.clear();
     ...
     * @param reader
     */
    public static fr.jmmc.jmcs.data.castor.Prerelease unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.jmmc.jmcs.data.castor.Prerelease) Unmarshaller.unmarshal(fr.jmmc.jmcs.data.castor.Prerelease.class, reader);
