...
public class Releasenotes implements java.io.Serializable {
     ...
     * @param vRelease
     */
    public void addRelease(fr.jmmc.jmcs.data.castor.Release vRelease)
     ...
     * @param vRelease
     */
    public void addRelease(int index, fr.jmmc.jmcs.data.castor.Release vRelease)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param index
     */
    public fr.jmmc.jmcs.data.castor.Release getRelease(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (fr.jmmc.jmcs.data.castor.Release) _releaseList.get(index);
    } //-- fr.jmmc.mcs.gui.castor.Release getRelease(int) 

    /**
     * Method getRelease
     */
    public fr.jmmc.jmcs.data.castor.Release[] getRelease()
    {
        int size = _releaseList.size();
        fr.jmmc.jmcs.data.castor.Release[] mArray = new fr.jmmc.jmcs.data.castor.Release[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (fr.jmmc.jmcs.data.castor.Release) _releaseList.get(index);
        }
        return mArray;
     ...
     * @param vRelease
     */
    public boolean removeRelease(fr.jmmc.jmcs.data.castor.Release vRelease)
    {
     ...
     * @param vRelease
     */
    public void setRelease(int index, fr.jmmc.jmcs.data.castor.Release vRelease)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _releaseList.size())) {
     ...
     * @param releaseArray
     */
    public void setRelease(fr.jmmc.jmcs.data.castor.Release[] releaseArray)
    {
        //-- copy array
        _releaseList.clear();
     ...
     * @param reader
     */
    public static fr.jmmc.jmcs.data.castor.Releasenotes unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.jmmc.jmcs.data.castor.Releasenotes) Unmarshaller.unmarshal(fr.jmmc.jmcs.data.castor.Releasenotes.class, reader);
