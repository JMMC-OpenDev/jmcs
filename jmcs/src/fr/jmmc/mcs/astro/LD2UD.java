...
public class LD2UD {
     ...
     * 
     * @param table
     * @param tempClassCode sptype temperature class code.
     * @param columnIndex return index for teff or logg.
     * @return one teff or logg
     */
    ...
    private static double searchLogg(double[][] table, int tempClassCode) {
        double result = path1(table, tempClassCode, 2) + SUN_LOGG;
