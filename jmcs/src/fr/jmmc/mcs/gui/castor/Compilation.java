...
public class Compilation implements java.io.Serializable {
     ...
     * @param reader
     */
    public static fr.jmmc.mcs.gui.castor.Compilation unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.jmmc.mcs.gui.castor.Compilation) Unmarshaller.unmarshal(fr.jmmc.mcs.gui.castor.Compilation.class, reader);
