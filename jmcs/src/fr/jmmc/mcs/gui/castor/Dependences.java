 ...
 * Schema.
 * $Id: Dependences.java,v 1.1 2010-06-18 08:32:50 mella Exp $
 */
...
public class Dependences implements java.io.Serializable {
     ...
     * @param v_package
     */
    public void add_package(fr.jmmc.mcs.gui.castor.Package v_package)
     ...
     * @param v_package
     */
    public void add_package(int index, fr.jmmc.mcs.gui.castor.Package v_package)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param index
     */
    public fr.jmmc.mcs.gui.castor.Package get_package(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (fr.jmmc.mcs.gui.castor.Package) _packageList.get(index);
    } //-- fr.jmmc.mcs.gui.castor.Package get_package(int) 

    /**
     * Method get_package
     */
    public fr.jmmc.mcs.gui.castor.Package[] get_package()
    {
        int size = _packageList.size();
        fr.jmmc.mcs.gui.castor.Package[] mArray = new fr.jmmc.mcs.gui.castor.Package[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (fr.jmmc.mcs.gui.castor.Package) _packageList.get(index);
        }
        return mArray;
     ...
     * @param v_package
     */
    public boolean remove_package(fr.jmmc.mcs.gui.castor.Package v_package)
    {
     ...
     * @param v_package
     */
    public void set_package(int index, fr.jmmc.mcs.gui.castor.Package v_package)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _packageList.size())) {
     ...
     * @param _packageArray
     */
    public void set_package(fr.jmmc.mcs.gui.castor.Package[] _packageArray)
    {
        //-- copy array
        _packageList.clear();
     ...
     * @param reader
     */
    public static fr.jmmc.mcs.gui.castor.Dependences unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.jmmc.mcs.gui.castor.Dependences) Unmarshaller.unmarshal(fr.jmmc.mcs.gui.castor.Dependences.class, reader);
