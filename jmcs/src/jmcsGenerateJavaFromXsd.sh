...
MODEL_SCHEMA=fr/jmmc/jmcs/data/ApplicationDataModel.xsd
if [ "$MODEL_SCHEMA" -nt "fr/jmmc/jmcs/data/castor" ]
then
    ...
    java -classpath $(mkfMakeJavaClasspath) org.exolab.castor.builder.SourceGenerator -types j2 -i ${MODEL_SCHEMA} -f -package fr.jmmc.jmcs.data.castor $*
else
