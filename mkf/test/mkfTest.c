 ...
 * JMMC project
 * 
 * "@(#) $Id: mkfTest.c,v 1.2 2005-02-15 09:12:26 gzins Exp $"
 *
 * History
 * -------
...
static char *rcsId="@(#) $Id: mkfTest.c,v 1.2 2005-02-15 09:12:26 gzins Exp $"; 
...
void mkfTestFunction(void )
{
    printf("mkfTestFunction()\n");
}
