...
{
    logTrace("modcppOPERATION::Divide()");
...
{
    logTrace("modcppOPERATION::SubAndMultiply()");
...
{
    logTrace("modcppOPERATION::SetName()");
...
{
    logTrace("modcppOPERATION::GetName()");
...
{
    logTrace("modcppOPERATION::Multiply()");
