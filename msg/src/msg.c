...
* JMMC project
* 
* "@(#) $Id: msg.c,v 1.1 2004-08-24 15:01:53 lafrasse Exp $"
*
* who       when         what
* --------  -----------  -------------------------------------------------------
...
static char *rcsId="@(#) $Id: msg.c,v 1.1 2004-08-24 15:01:53 lafrasse Exp $"; 
                                   ...
                                   mcsINT32           bufLen)
{
    ...
    msg->header.msgBodySize = htonl(bufLen);
...
mcsINT32        msgGetBodySize    (msgMESSAGE         *msg)
{
    ...
    return (ntohl (msg->header.msgBodySize));
}
