...
{
    logExtDbg("msgDEBUG_CMD::GetStdoutLevel()");	
...
{
    logExtDbg("msgDEBUG_CMD::IsDefinedStdoutLevel()");
...
{
    logExtDbg("msgDEBUG_CMD::GetLogfileLevel()");	
...
{
    logExtDbg("msgDEBUG_CMD::IsDefinedLogfileLevel()");
...
{
    logExtDbg("msgDEBUG_CMD::GetPrintDate()");	
...
{
    logExtDbg("msgDEBUG_CMD::IsDefinedPrintDate()");
...
{
    logExtDbg("msgDEBUG_CMD::GetPrintFileLine()");	
...
{
    logExtDbg("msgDEBUG_CMD::IsDefinedPrintFileLine()");
