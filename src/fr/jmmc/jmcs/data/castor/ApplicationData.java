...
public class ApplicationData implements java.io.Serializable {
     ...
     * Field _program
     */
    private fr.jmmc.jmcs.data.castor.Program _program;

    /**
     * Field _compilation
     */
    private fr.jmmc.jmcs.data.castor.Compilation _compilation;
     ...
     * Field _dependences
     */
    private fr.jmmc.jmcs.data.castor.Dependences _dependences;

    /**
     * Field _menubar
     */
    private fr.jmmc.jmcs.data.castor.Menubar _menubar;

    /**
     * Field _releasenotes
     */
    private fr.jmmc.jmcs.data.castor.Releasenotes _releasenotes;
     ...
     */
    public fr.jmmc.jmcs.data.castor.Compilation getCompilation()
    {
     ...
     */
    public fr.jmmc.jmcs.data.castor.Dependences getDependences()
    {
     ...
     */
    public fr.jmmc.jmcs.data.castor.Program getProgram()
    {
     ...
     */
    public fr.jmmc.jmcs.data.castor.Releasenotes getReleasenotes()
    {
     ...
     */
    public void setCompilation(fr.jmmc.jmcs.data.castor.Compilation compilation)
    {
     ...
     */
    public void setDependences(fr.jmmc.jmcs.data.castor.Dependences dependences)
    {
     ...
     */
    public void setMenubar(fr.jmmc.jmcs.data.castor.Menubar menubar)
    {
     ...
     */
    public void setProgram(fr.jmmc.jmcs.data.castor.Program program)
    {
     ...
     */
    public void setReleasenotes(fr.jmmc.jmcs.data.castor.Releasenotes releasenotes)
    {
     ...
     * @param reader
     */
    public static fr.jmmc.jmcs.data.castor.ApplicationData unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.jmmc.jmcs.data.castor.ApplicationData) Unmarshaller.unmarshal(fr.jmmc.jmcs.data.castor.ApplicationData.class, reader);
