...
public class Release implements java.io.Serializable {
     ...
     * @param vPrerelease
     */
    public void addPrerelease(fr.jmmc.jmcs.data.castor.Prerelease vPrerelease)
     ...
     * @param vPrerelease
     */
    public void addPrerelease(int index, fr.jmmc.jmcs.data.castor.Prerelease vPrerelease)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param index
     */
    public fr.jmmc.jmcs.data.castor.Prerelease getPrerelease(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (fr.jmmc.jmcs.data.castor.Prerelease) _prereleaseList.get(index);
    } //-- fr.jmmc.mcs.gui.castor.Prerelease getPrerelease(int) 

    /**
     * Method getPrerelease
     */
    public fr.jmmc.jmcs.data.castor.Prerelease[] getPrerelease()
    {
        int size = _prereleaseList.size();
        fr.jmmc.jmcs.data.castor.Prerelease[] mArray = new fr.jmmc.jmcs.data.castor.Prerelease[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (fr.jmmc.jmcs.data.castor.Prerelease) _prereleaseList.get(index);
        }
        return mArray;
     ...
     * @param vPrerelease
     */
    public boolean removePrerelease(fr.jmmc.jmcs.data.castor.Prerelease vPrerelease)
    {
     ...
     * @param vPrerelease
     */
    public void setPrerelease(int index, fr.jmmc.jmcs.data.castor.Prerelease vPrerelease)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _prereleaseList.size())) {
     ...
     */
    public void setPrerelease(fr.jmmc.jmcs.data.castor.Prerelease[] prereleaseArray)
    {
        //-- copy array
        _prereleaseList.clear();
     ...
     * @param reader
     */
    public static fr.jmmc.jmcs.data.castor.Release unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (fr.jmmc.jmcs.data.castor.Release) Unmarshaller.unmarshal(fr.jmmc.jmcs.data.castor.Release.class, reader);
